...
pub static X86_FEATURE_STRINGS : Singleton<SortArr<i32, &'static str>> = Singleton::<SortArr<i32, &'static str>>::New();
pub static X86_FEATURE_PARSE_ONLY_STRINGS : Singleton<SortArr<i32, &'static str>> = Singleton::<SortArr<i32, &'static str>>::New();

...
impl SpliceOperations for NoReadWriteFile {}

impl FileOperations for NoReadWriteFile {
    fn as_any(&self) -> &Any {
        return self;
    }

    fn FopsType(&self) -> FileOpsType {
        return FileOpsType::NoReadWriteFile;
    }
...
impl SockOperations for NoReadWriteFile {}

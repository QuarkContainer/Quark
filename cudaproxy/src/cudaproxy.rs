...
pub extern "C" fn __cudaUnregisterFatBinary(fatCubinHandle:u64) {
    ...
    let fatCubinHandlePtr: *const u64 = fatCubinHandle as *const u64;
    unsafe{
        //  if *fatCubinHandlePtr != 0 {
        //  println!("the content of fatCubin Handle pointer is not 0, need to unload the module");

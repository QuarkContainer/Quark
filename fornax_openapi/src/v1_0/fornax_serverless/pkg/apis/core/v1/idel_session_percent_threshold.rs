// Generated from definition io.centaurusinfra.fornax-serverless.pkg.apis.core.v1.IdelSessionPercentThreshold
...
pub struct IdelSessionPercentThreshold {
...
impl crate::DeepMerge for IdelSessionPercentThreshold {
...
impl<'de> crate::serde::Deserialize<'de> for IdelSessionPercentThreshold {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            type Value = IdelSessionPercentThreshold;

            fn expecting(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                f.write_str("IdelSessionPercentThreshold")
            }
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                Ok(IdelSessionPercentThreshold {
                    high: value_high,
                    low: value_low,
                })
            }
...
impl crate::serde::Serialize for IdelSessionPercentThreshold {
...
impl crate::schemars::JsonSchema for IdelSessionPercentThreshold {
    fn schema_name() -> String {
        "io.centaurusinfra.fornax-serverless.pkg.apis.core.v1.IdelSessionPercentThreshold".to_owned()
    }
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("scaling down when idle session percent more than this number".to_owned()),
                                ..Default::default()
                            })),
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("scaling up when idle session percent less than this number".to_owned()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(crate::schemars::schema::InstanceType::Integer))),
                            format: Some("int64".to_owned()),

...
pub(crate) mod json_ty {
    pub(crate) fn json_schema_props_or_array(
        ...
        for namespace in ["v1beta1", "v1"] {
            ...
            if let Some(definition) = spec.definitions.get_mut(&definition_path) {
                if !matches!(
                    definition.kind,
                    crate::swagger20::SchemaKind::Ty(crate::swagger20::Type::JsonSchemaPropsOr(
                        _,
                        crate::swagger20::JsonSchemaPropsOr::Array
                    )),
                ) {
                    definition.kind = crate::swagger20::SchemaKind::Ty(
                        crate::swagger20::Type::JsonSchemaPropsOr(
                            namespace,
                            crate::swagger20::JsonSchemaPropsOr::Array,
                        ),
                    );
    ...
    pub(crate) fn json_schema_props_or_bool(
        spec: &mut crate::swagger20::Spec,
    ) -> Result<(), crate::Error> {
        let mut found = false;
        ...
        for namespace in ["v1beta1", "v1"] {
            ...
            if let Some(definition) = spec.definitions.get_mut(&definition_path) {
                if !matches!(
                    ...
                    crate::swagger20::SchemaKind::Ty(crate::swagger20::Type::JsonSchemaPropsOr(
                        _,
                        crate::swagger20::JsonSchemaPropsOr::Bool
                    )),
                ) {
                    definition.kind = crate::swagger20::SchemaKind::Ty(
                        crate::swagger20::Type::JsonSchemaPropsOr(
    ...
    pub(crate) fn json_schema_props_or_string_array(
        spec: &mut crate::swagger20::Spec,
    ) -> Result<(), crate::Error> {
        let mut found = false;
        ...
        for namespace in ["v1beta1", "v1"] {
            ...
            if let Some(definition) = spec.definitions.get_mut(&definition_path) {
                if !matches!(
                    ...
                    crate::swagger20::SchemaKind::Ty(crate::swagger20::Type::JsonSchemaPropsOr(
                        _,
                        crate::swagger20::JsonSchemaPropsOr::StringArray
                    )),
                ) {
                    definition.kind = crate::swagger20::SchemaKind::Ty(
                        crate::swagger20::Type::JsonSchemaPropsOr(
...
pub(crate) fn create_delete_optional(
    spec: &mut crate::swagger20::Spec,
) -> Result<(), crate::Error> {
    let delete_options_schema = spec
        .definitions
        .get(&crate::swagger20::DefinitionPath(
    ...
    let delete_optional_properties = delete_options_properties
        .iter()
        .map(|(name, (schema, _))| (name.clone(), schema.clone()))
        .collect();

    spec.definitions.insert(
        crate::swagger20::DefinitionPath("io.k8s.DeleteOptional".to_owned()),
        crate::swagger20::Schema {
            description: Some(
                "Common parameters for all delete and delete-collection operations.".to_owned(),
            ),
...
pub(crate) fn create_optionals(spec: &mut crate::swagger20::Spec) -> Result<(), crate::Error> {
    ...
    const OPTIONALS: &[(
        ...
        fn(
            std::collections::BTreeMap<crate::swagger20::PropertyName, crate::swagger20::Schema>,
        ) -> crate::swagger20::Type,
    )] = &[
        (
            "create",
            "io.k8s.CreateOptional",
            crate::swagger20::KubernetesAction::Post,
            crate::swagger20::Type::CreateOptional,
        ),
        (
            "patch",
            "io.k8s.PatchOptional",
            crate::swagger20::KubernetesAction::Patch,
            crate::swagger20::Type::PatchOptional,
        ),
        (
            "replace",
            "io.k8s.ReplaceOptional",
            crate::swagger20::KubernetesAction::Put,
            crate::swagger20::Type::ReplaceOptional,
        ),
    ];
    ...
    for &(description, type_name, kubernetes_action, ty) in OPTIONALS {
        ...
        let mut optional_definition: std::collections::BTreeMap<
            crate::swagger20::PropertyName,
            crate::swagger20::Schema,
        > = Default::default();
        ...
        let optional_parameter = std::sync::Arc::new(crate::swagger20::Parameter {
            ...
            schema: crate::swagger20::Schema {
                description: Some(
                    "Optional parameters. Use `Default::default()` to not pass any.".to_owned(),
                ),
        ...
        for operation in &mut spec.operations {
            ...
            if !operation.id.starts_with(description) {
                return Err(format!(
                    ...
                    operation.id, operation.kubernetes_action
                )
                .into());
            }

            {
                let optional_parameters = &*optional_parameters.get_or_insert_with(|| {
                    operation
                        .parameters
                        .iter()
                        .filter_map(|p| {
                ...
                for expected_parameter_name in optional_parameters {
                    ...
                    optional_definition
                        .entry(crate::swagger20::PropertyName(
                            expected_parameter_name.clone(),
                        ))
                ...
                for parameter in &operation.parameters {
                    if !parameter.required && !optional_parameters.contains(&*parameter.name) {
                        return Err(format!(
                            "operation {} contains unexpected optional parameter {}",
        ...
        spec.definitions.insert(
            crate::swagger20::DefinitionPath(type_name.to_string()),
            crate::swagger20::Schema {
                description: Some(format!(
                    "Common parameters for all {description} operations."
                )),
...
pub(crate) fn patch(spec: &mut crate::swagger20::Spec) -> Result<(), crate::Error> {
    let definition_path =
        crate::swagger20::DefinitionPath("io.k8s.apimachinery.pkg.apis.meta.v1.Patch".to_owned());
    if let Some(definition) = spec.definitions.get_mut(&definition_path) {
...
pub(crate) fn remove_delete_collection_operations_query_parameters(
    spec: &mut crate::swagger20::Spec,
) -> Result<(), crate::Error> {
    let mut found = false;
    ...
    for operation in &mut spec.operations {
        if operation.kubernetes_action == Some(crate::swagger20::KubernetesAction::DeleteCollection)
        {
            operation.parameters = operation
                .parameters
                .drain(..)
                .filter(|p| p.location == crate::swagger20::ParameterLocation::Path)
                .collect();
            operation
                .parameters
                .push(std::sync::Arc::new(crate::swagger20::Parameter {
                    location: crate::swagger20::ParameterLocation::Body,
                    name: "deleteOptional".to_owned(),
                    required: true,
                    schema: crate::swagger20::Schema {
                        description: Some(
                            "Delete options. Use `Default::default()` to not pass any.".to_owned(),
                        ),
                        kind: crate::swagger20::SchemaKind::Ref(crate::swagger20::RefPath {
            ...
            operation
                ...
                .push(std::sync::Arc::new(crate::swagger20::Parameter {
                    ...
                    schema: crate::swagger20::Schema {
                        description: Some(
                            "List options. Use `Default::default()` to not pass any.".to_owned(),
                        ),
                        kind: crate::swagger20::SchemaKind::Ref(crate::swagger20::RefPath {
...
pub(crate) fn remove_delete_operations_query_parameters(
    spec: &mut crate::swagger20::Spec,
) -> Result<(), crate::Error> {
    let mut found = false;
    ...
    for operation in &mut spec.operations {
        if operation.kubernetes_action == Some(crate::swagger20::KubernetesAction::Delete) {
            if let Some(body_parameter) = operation
                .parameters
                .iter()
                .find(|p| p.location == crate::swagger20::ParameterLocation::Body)
            {
                if let crate::swagger20::SchemaKind::Ref(crate::swagger20::RefPath {
                    path, ..
                }) = &body_parameter.schema.kind
                {
                ...
                return Err(format!(
                    "DELETE operation {} does not have a DeleteOptions body parameter",
                    operation.id
                )
                .into());
            }
...
pub(crate) fn remove_read_operations_query_parameters(
    spec: &mut crate::swagger20::Spec,
) -> Result<(), crate::Error> {
    let mut found = false;
...
pub(crate) fn separate_watch_from_list_operations(
    spec: &mut crate::swagger20::Spec,
) -> Result<(), crate::Error> {
    use std::fmt::Write;

    let mut list_optional_parameters: Option<std::collections::HashSet<String>> = None;
    let mut list_optional_definition: std::collections::BTreeMap<
        crate::swagger20::PropertyName,
        crate::swagger20::Schema,
    > = Default::default();
    let mut watch_optional_definition: std::collections::BTreeMap<
        crate::swagger20::PropertyName,
        crate::swagger20::Schema,
    > = Default::default();
    ...
    for operation in &mut spec.operations {
        ...
        if !operation.id.starts_with("list") {
            return Err(format!(
                r#"operation {} is a list operation but doesn't start with "list""#,
                operation.id
            )
            .into());
        }

        let list_optional_parameters = &*list_optional_parameters.get_or_insert_with(|| {
            operation
                .parameters
                .iter()
                .map(|p| p.name.clone())
        ...
        for expected_parameter_name in list_optional_parameters {
            ...
            if expected_parameter_name != "allowWatchBookmarks"
            ...
            if expected_parameter_name != "continue"
    ...
    spec.definitions.insert(
        crate::swagger20::DefinitionPath("io.k8s.ListOptional".to_string()),
        crate::swagger20::Schema {
    ...
    spec.definitions.insert(
        crate::swagger20::DefinitionPath("io.k8s.WatchOptional".to_string()),
        crate::swagger20::Schema {
    ...
    for list_operation_id in list_operations {
        ...
        let watch_list_operation_id = if watch_operation_id.ends_with("ForAllNamespaces") {
            watch_operation_id[..(watch_operation_id.len() - "ForAllNamespaces".len())].to_owned()
                + "ListForAllNamespaces"
        } else {
            watch_operation_id.clone() + "List"
        };

        if let Some(watch_operation_index) = spec
            .operations
            .iter()
            .position(|o| o.id == watch_operation_id)
        {
            spec.operations.swap_remove(watch_operation_index);
        }
        if let Some(watch_list_operation_index) = spec
            .operations
            .iter()
            .position(|o| o.id == watch_list_operation_id)
        {
            spec.operations.swap_remove(watch_list_operation_index);
        }

        let (original_list_operation_index, original_list_operation) = spec
            .operations
            .iter()
            .enumerate()
            .find(|(_, o)| o.id == list_operation_id)
            .unwrap();

        let mut base_description = original_list_operation
            .description
            .as_ref()
        ...
        list_operation.parameters = list_operation
            .parameters
            .into_iter()
        ...
        watch_operation.parameters = watch_operation
            .parameters
            .into_iter()
            .filter(|parameter| parameter.required)
    ...
    for operation in &spec.operations {
        if let Some(
            crate::swagger20::KubernetesAction::Watch
            | crate::swagger20::KubernetesAction::WatchList,
        ) = operation.kubernetes_action
        {
    ...
    if let Some(mut definition) = spec.definitions.remove(&definition_path) {
        if let crate::swagger20::SchemaKind::Properties(mut properties) = definition.kind {
            ...
            if let Some((object_property, true)) = properties.remove(&object_property_name) {
                if let crate::swagger20::SchemaKind::Ref(raw_extension_ref_path) =
                    object_property.kind
                {
                    definition.kind = crate::swagger20::SchemaKind::Ty(
                        crate::swagger20::Type::WatchEvent(raw_extension_ref_path),
                    );
...
pub(crate) fn list(spec: &mut crate::swagger20::Spec) -> Result<(), crate::Error> {
    ...
    for (definition_path, definition) in &spec.definitions {
        ...
        let item_gkv_corresponds_to_list_gkv = list_kubernetes_group_kind_version.group
            == item_kubernetes_group_kind_version.group
            && list_kubernetes_group_kind_version.version
                == item_kubernetes_group_kind_version.version
            && list_kubernetes_group_kind_version.kind
                == format!("{}List", item_kubernetes_group_kind_version.kind);
        ...
        if let Some((_, list_property_names)) = &list_properties {
            let property_names: std::collections::BTreeSet<_> =
    ...
    let (metadata_schema_kind, _) =
        list_properties.ok_or("did not find any types that looked like a list")?;
    ...
    for (definition_path, item_ref_path, list_kind) in &list_definition_paths {
        let item_definition = spec
            .definitions
            .get_mut(&crate::swagger20::DefinitionPath(
                item_ref_path.path.clone(),
            ))
            .unwrap();
...
pub(crate) fn response_types(spec: &mut crate::swagger20::Spec) -> Result<(), crate::Error> {
    ...
    const TYPES: &[(
        ...
        ) -> Result<(&'static str, crate::swagger20::Type), crate::Error>,
    )] = &[
        ("io.k8s.CreateResponse", create_response),
        (
            "io.k8s.DeleteResponse",
            delete_and_delete_collection_response,
        ),
    ...
    fn create_response(
        ...
        for operation in &mut spec.operations {
            if operation.kubernetes_action == Some(crate::swagger20::KubernetesAction::Post) {
                ...
                operation.responses = crate::swagger20::OperationResponses::Common(
    ...
    fn delete_and_delete_collection_response(
        spec: &mut crate::swagger20::Spec,
    ) -> Result<(&'static str, crate::swagger20::Type), crate::Error> {
        ...
        for operation in &mut spec.operations {
            match operation.kubernetes_action {
                ...
                Some(crate::swagger20::KubernetesAction::DeleteCollection) => {
                    ...
                    // delete-collection does not have 202, but we'll synthesize it anyway
                    {
    ...
    fn list_response(
        ...
        for operation in &mut spec.operations {
            if operation.kubernetes_action == Some(crate::swagger20::KubernetesAction::List) {
                ...
                let group_version_kind = operation
                    .kubernetes_group_kind_version
                    .as_ref()
                    .ok_or_else(|| {
                        format!(
                            "operation {} looks like a list but doesn't have a group-version-kind",
                            operation.id
                        )
                    })?;
                let expected_ref_path_suffix = format!(".{}", group_version_kind.kind);
                ...
                let should_use_common_response_type =
                    responses
                        .values()
                        .all(|crate::swagger20::Schema { kind, .. }| {
                            if let crate::swagger20::SchemaKind::Ty(
                                crate::swagger20::Type::ListRef { items },
                            ) = kind
                            {
        ...
        for operation in &mut spec.operations {
            if operation.kubernetes_action == Some(crate::swagger20::KubernetesAction::Patch) {
                ...
                if response_status_codes != [http::StatusCode::OK, http::StatusCode::CREATED]
                    && response_status_codes != [http::StatusCode::OK]
                // 1.21 and earlier did not have 201
                {
                ...
                let group_version_kind = operation
                    ...
                    .ok_or_else(|| {
                        format!(
                            "operation {} looks like a patch but doesn't have a group-version-kind",
                            operation.id
                        )
                    })?;
                let expected_ref_path_suffix = format!(".{}", group_version_kind.kind);

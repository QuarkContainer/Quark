...
pub(crate) fn pod_exec_command_parameter_type(
    ...
    if let Some(operation) = spec
        .operations
        .iter_mut()
        .find(|operation| operation.id == "connectCoreV1GetNamespacedPodExec")
    {
        ...
        {
            if let crate::swagger20::SchemaKind::Ty(crate::swagger20::Type::String {
                format: None,
                    ...
                    schema: crate::swagger20::Schema {
                        kind: crate::swagger20::SchemaKind::Ty(crate::swagger20::Type::Array {
                            items: Box::new(crate::swagger20::Schema {
                                description: None,
                                kind: crate::swagger20::SchemaKind::Ty(
                                    crate::swagger20::Type::String { format: None },
                                ),
    ...
    if found {
        ...
        Err(
            "never applied connectCoreV1GetNamespacedPodExec command parameter type override"
                .into(),
        )
    }
}
...
pub(crate) mod optional_properties {
    ...
    pub(crate) fn containerimage(spec: &mut crate::swagger20::Spec) -> Result<(), crate::Error> {
        let definition_path =
            crate::swagger20::DefinitionPath("io.k8s.api.core.v1.ContainerImage".to_owned());
        if let Some(definition) = spec.definitions.get_mut(&definition_path) {
            if let crate::swagger20::SchemaKind::Properties(properties) = &mut definition.kind {
                if let Some(property) =
                    properties.get_mut(&crate::swagger20::PropertyName("names".to_string()))
                {
                    if property.1 {
                        property.1 = false;
                        return Ok(());
...
pub(crate) mod required_properties {
    ...
    pub(crate) fn validating_admission_policy_binding_list(
        spec: &mut crate::swagger20::Spec,
    ) -> Result<(), crate::Error> {
        ...
        if let Some(definition) = spec.definitions.get_mut(&definition_path) {
            if let crate::swagger20::SchemaKind::Properties(properties) = &mut definition.kind {
                if let Some(property) =
                    properties.get_mut(&crate::swagger20::PropertyName("items".to_string()))
                {
                    if !property.1 {
                        property.1 = true;
                        return Ok(());
        ...
        Err(
            "never applied ValidatingAdmissionPolicyBindingList required properties override"
                .into(),
        )
    }

    // `ValidatingAdmissionPolicyList::items`
    pub(crate) fn validating_admission_policy_list(
        spec: &mut crate::swagger20::Spec,
    ) -> Result<(), crate::Error> {
        let definition_path = crate::swagger20::DefinitionPath(
            "io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicyList".to_owned(),
        );
        if let Some(definition) = spec.definitions.get_mut(&definition_path) {
            if let crate::swagger20::SchemaKind::Properties(properties) = &mut definition.kind {
                if let Some(property) =
...
pub(crate) fn status_extra_gvk(spec: &mut crate::swagger20::Spec) -> Result<(), crate::Error> {
    let definition_path =
        crate::swagger20::DefinitionPath("io.k8s.apimachinery.pkg.apis.meta.v1.Status".to_owned());
    if let Some(definition) = spec.definitions.get_mut(&definition_path) {
        if definition.kubernetes_group_kind_versions.len() > 1 {
            #[allow(clippy::comparison_to_empty)]
            definition
                .kubernetes_group_kind_versions
                .retain(|gvk| gvk.group == "" && gvk.kind == "Status" && gvk.version == "v1");
            if definition.kubernetes_group_kind_versions.len() == 1 {
                return Ok(());
            }
            ...
            return Err(format!(
				...
				definition.kubernetes_group_kind_versions)
            .into());
        }
    }

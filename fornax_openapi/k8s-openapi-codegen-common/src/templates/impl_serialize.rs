pub(crate) fn generate(
    ...
    let type_generics_impl = generics
        .type_part
        .map(|part| format!("<{part}>"))
        .unwrap_or_default();
    let type_generics_type = generics
        .type_part
        .map(|part| format!("<{part}>"))
        .unwrap_or_default();
    let type_generics_where = generics
        .where_part
        .map(|part| format!(" where {part}"))
        .unwrap_or_default();
    ...
    let serialize_type_name = if resource_metadata.is_some() {
        format!("<Self as {local}Resource>::KIND")
    } else {
        format!("{type_name:?}")
    };

    let struct_serializer: std::borrow::Cow<'_, str> = if has_flattened_field {
        ...
        writeln!(
            out,
            "            type Error = <S as {local}serde::ser::SerializeStruct>::Error;"
        )?;
        writeln!(out)?;
        writeln!(
            out,
            "            type SerializeSeq = {local}serde::ser::Impossible<Self::Ok, Self::Error>;"
        )?;
        ...
        writeln!(
            out,
            "            type SerializeMap = {local}serde::ser::Impossible<Self::Ok, Self::Error>;"
        )?;
        writeln!(
            out,
            "            type SerializeStruct = SerializerStructWrapper<'a, S>;"
        )?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("bool is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("i8 is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom(" is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("i32 is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("i64 is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("u8 is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("u16 is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("u32 is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("u64 is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("f32 is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("f64 is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("char is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("str is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("bytes is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("none is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("some is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        writeln!(
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("unit is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("unit struct is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("unit variant is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("newtype struct is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("newtype variant is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("seq is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("tuple is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("tuple struct is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("tuple variant is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("map is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out)?;
        ...
        writeln!(
            out,
            r#"                Err({local}serde::ser::Error::custom("struct variant is not supported"))"#
        )?;
        writeln!(out, "            }}")?;
        writeln!(out, "        }}")?;
        writeln!(out)?;
        writeln!(
            out,
            "        struct SerializerStructWrapper<'a, S>(&'a mut S);"
        )?;
        writeln!(out)?;

// #[tokio::test]
// async fn list() {
//     use fornax_openapi::api::core::v1 as api;
//
//     let mut client = crate::Client::new("pod-list");
//
//     let (request, response_body) =
//         api::Pod::list("kube-system", Default::default()).expect("couldn't list pods");
...
//
//     let apiserver_container_spec = apiserver_pod
//         .spec
//         .expect("couldn't get apiserver pod spec")
//         .containers
//         .into_iter()
//         .next()
//         .expect("couldn't get apiserver container spec");
//     assert_eq!(apiserver_container_spec.name, "kube-apiserver");
//
//     let apiserver_pod_status = apiserver_pod
//         .status
//         .expect("couldn't get apiserver pod status");
